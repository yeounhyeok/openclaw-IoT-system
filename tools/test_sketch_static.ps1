...
$requiredSnippets = @(
  ...
  @{ Pattern = "input_button.openclaw_pc_power"; Message = "Home Assistant PC power button helper entity is missing." },
  ...
  @{ Pattern = "void pollHaPcPowerButton()"; Message = "Home Assistant PC power button polling function is missing." },
