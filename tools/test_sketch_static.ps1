...
$requiredSnippets = @(
  ...
  @{ Pattern = "input_button.openclaw_pc_power"; Message = "Home Assistant PC power button compatibility entity is missing." },
  ...
  @{ Pattern = "void pollHaPcPowerButton()"; Message = "Home Assistant PC power button polling compatibility function is missing." },
  @{ Pattern = "HA WS PC power button request"; Message = "Home Assistant WebSocket should handle input_button PC power requests." },
  @{ Pattern = "PC power servo command from "; Message = "PC power servo command should be logged for hardware diagnosis." },
  ...
  @{ Pattern = "#define HA_WS_READ_TIMEOUT_MS 250"; Message = "HA WS frame read timeout should be short so loop stays responsive." },
  ...
  @{ Pattern = "pcPowerBeepsAfterServo"; Message = "PC power beep should be deferred until after servo motion." },
